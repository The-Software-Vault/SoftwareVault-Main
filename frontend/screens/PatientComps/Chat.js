...
const doctorsList = [
    ...
    { id: '5', image: require('../../assets/doctors/doctor-1.png'), name: 'Dr.Ronan Peiterson', message: 'Hello, How can i help you?', time: '1d ago', isActive: true },
    { id: '6', image: require('../../assets/doctors/doctor-2.png'), name: 'Dr.Brayden Thread', message: 'Okay', time: '1d ago', isActive: false },
    { id: '7', image: require('../../assets/doctors/doctor-3.png'), name: 'Dr.Apollonia Ellison', message: 'Good', time: '5d ago', isActive: false },
    { id: '8', image: require('../../assets/doctors/doctor-4.png'), name: 'Dr.Beatriz Watson', message: 'Take Care.', time: '1w ago', isActive: false },
];
